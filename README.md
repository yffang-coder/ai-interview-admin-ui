...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;"> ai-interview-admin-ui v1.0.0</h1>
...
* 配套后端代码仓库地址[ai-interview-controller](https://github.com/yffang-coder/ai-interview-controller) 版本。
...
## 内置功能
0.    ai管理：banner管理、 ai模型、科目、科目细则、告警管理。
